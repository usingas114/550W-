...
private:
    ...
    void displaySystemInfo() {
        cout << "\n[系统信息]\n";
        cout << "AI核心: 量子神经网络 v4.21\n";
        cout << "处理器: 光子计算阵列 (1.42 ZFLOPS)\n";
        cout << "内存: 84PB HBM5\n";
        cout << "存储: 3.2YB 量子晶体存储\n";
...
public:
    Simulator550W(string name) : codename(name), activated(false), debugMode(false), mossMode(false), threatLevel(0) {
        fileSystem["mission.log"] = "流浪地球计划 - 阶段3";
        fileSystem["quantum_data.qd"] = "加密量子态数据";
        fileSystem["ai_core.cfg"] = "神经网络配置 v4.2";
    ...
    void processCommand(string cmd) {
        ...
        if (cmd == "help") {
            ...
            cout << "\n[系统状态]" << endl;
            cout << "核心温度: " << (28 + rand() % 5) << ".7°C" << endl;
            cout << "量子位稳定性: " << (99.8 + (rand() % 20)/100.0) << "%" << endl;
            cout << "全球节点: " << globalNodes.size() << "/" << globalNodes.size() << " 在线" << endl;
            cout << "当前负载: " << (15 + rand() % 70) << "%" << endl;
